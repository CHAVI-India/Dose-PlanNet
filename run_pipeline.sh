...
# Remove cache
# rm -rf "/mnt/nvme/nvme-2TB-storage/sougata/python/Multichannel-Dose-Prediction-for-Radiotherapy-Planning/01 ICON/preprocess/Dataset001_ProstateDose/persistent_cache_physics/"
